(() => {
  ...
  manifest.dataset.mode = "1s1a";

  document.head.prepend(manifest);

  console.log(
    "OJapp 1S1A manifest inserted",
    {
      executedAt:
  ...
  const messages = {
    ...
    en: {
      text:
        "Add this site to your home screen as an app.",
